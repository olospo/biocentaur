  ...
  <div class="container">
    <div class="filter ten columns offset-by-one">
      ...
      <form id="footer-faq-form" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post">
          ...
          <input type="search" placeholder="Enter your keyword" id="footer-faq-search" name="faq_searchterm" value="<?php echo $searchterm ?>">
          <input type="submit" id="faq-search-submit" value/>
      </form>
    </div>
